        ...
        let(:expected) do
          {
            ...
            "$push" => {
              "children.$.children.1.children.3.fields" => { "$each" => [ "value", "value" ] }
            }
          }
        end
      ...
      let(:expected) do
        {
          ...
          "$push" => {
            "children.0.children.$.children.3.fields" => { "$each" => [ "value", "value" ] }
          }
        }
      end
      ...
      let(:expected) do
        {
          ...
          "$push" => {
            "children.0.children.1.children.$.fields" => { "$each" => [ "value", "value" ] }
          }
        }
      end
